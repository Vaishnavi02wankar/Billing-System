...
if(isset($_POST['submit']))
{
	...
	//print_r($_POST);exit;	
try{
        $stmt = $conn->prepare("INSERT INTO `customers`(`date`,`customer_name`,`mobile`,`email`,`address`) VALUES(:date,:customer_name,:mobile,:email,:address)");

		$executed=$stmt->execute(array(':date' => $date,':customer_name' => $customer_name,':mobile' => $mobile,':email' => $email,':address'=> $address));
			   if($executed)
			   {
                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" name="customer_name" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
